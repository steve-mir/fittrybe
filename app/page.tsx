    ...
    <section id="hero" style={{
      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
        <video autoPlay muted loop playsInline style={{
          ...
          objectFit: "cover", opacity: 0.2, filter: "saturate(0.3) brightness(0.6)",
        }}>
          <source src="/videos/hero.mp4" type="video/mp4" />
        </video>
        <div style={{
          position: "absolute", inset: 0,
          background: "radial-gradient(ellipse at 50% 40%, rgba(182,255,0,0.06) 0%, transparent 60%), linear-gradient(to bottom, rgba(5,5,5,0.3) 0%, rgba(5,5,5,0.5) 50%, rgba(5,5,5,1) 100%)",
        }} />
      </div>
      ...
      <motion.p
        ...
        style={{
          ...
          color: "#6B7280", marginTop: "1.5rem", marginBottom: "2.5rem",
          letterSpacing: "0.01em", lineHeight: 1.6,
        }}
      >
        Discover local sports sessions, connect with your city, and play.
      </motion.p>
      ...
      >
        <a
          ...
          style={{
            ...
            borderRadius: 12,
            fontFamily: "'Barlow Condensed', sans-serif",
            fontWeight: 800, fontSize: "1.1rem", letterSpacing: "0.07em",
            textTransform: "uppercase", textDecoration: "none",
            transition: "box-shadow 0.2s, transform 0.2s",
          }}
          onMouseEnter={e => { e.currentTarget.style.boxShadow = "0 8px 28px rgba(182,255,0,0.35)"; e.currentTarget.style.transform = "scale(1.03)"; }}
          onMouseLeave={e => { e.currentTarget.style.boxShadow = ""; e.currentTarget.style.transform = ""; }}
        >
      ...
      >
        <span style={{ fontSize: "0.6rem", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: "#2a2a2a" }}>SCROLL</span>
        <motion.div
          animate={{ y: [0, 8, 0] }}
          transition={{ repeat: Infinity, duration: 1.8, ease: "easeInOut" }}
          style={{ width: 1, height: 36, background: "linear-gradient(to bottom, #2a2a2a, transparent)" }}
        />
      </motion.div> */}
    </section>
  );
...
function StickyScrollStoryOld() {
  ...
  const slideIndex = useTransform(scrollYProgress, [0, 0.33, 0.34, 0.66, 0.67, 1], [0, 0, 1, 1, 2, 2]);

  const [activeSlide, setActiveSlide] = useState(0);
  useEffect(() => {
    return slideIndex.onChange(v => setActiveSlide(Math.round(v)));
  }, [slideIndex]);

  const opacity0 = useTransform(scrollYProgress, [0, 0.01, 0.32, 0.38], [0, 1, 1, 0]);
  const opacity1 = useTransform(scrollYProgress, [0.28, 0.34, 0.65, 0.72], [0, 1, 1, 0]);
  const opacity2 = useTransform(scrollYProgress, [0.61, 0.68, 0.98, 1], [0, 1, 1, 0]);
  const opacities = [opacity0, opacity1, opacity2];
      ...
      <div style={{
        ...
        {SCROLL_SLIDES.map((slide, i) => (
          ...
          >
            ...
            >
              <span style={{ display: "block", fontSize: "0.32em", color: "#B6FF00", marginBottom: "0.5rem", letterSpacing: "0.08em" }}>
                {slide.label}
              </span>
              {slide.word}
              <span style={{ display: "block", fontSize: "0.22em", color: "#4B5563", fontWeight: 500, letterSpacing: "0.05em", textTransform: "uppercase", marginTop: "0.8rem", fontFamily: "'DM Sans', sans-serif" }}>
                {slide.sub}
              </span>
            </div>
          </motion.div>
        ...
        <div style={{
          ...
          marginLeft: "auto", marginRight: "10vw",
        }}>
          <div style={{
            width: 280, height: 580,
            background: "#0a0a0a",
